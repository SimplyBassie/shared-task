...
def Abestxlnet():
    ...
    if 'subtaskc' in path.lower():
        ...
        numlab=2
        weights = [1,15]
    model = ClassificationModel(architecture, model_type, args=args, use_cuda = False, num_labels=numlab) # You can set class weights by using the optional weight argument
